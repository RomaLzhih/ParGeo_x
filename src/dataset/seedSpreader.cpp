...
[2] Junhao Gan, Yufei Tao. DBSCAN Revisited: Mis-Claim, Un-Fixability, and
Approximation
*/
...
double
pargeo::seedSpreader::internal::randomDouble( double lo, double hi )
{
...
template <int dim>
pargeo::seedSpreader::internal::spreader<dim>::spreader( int _cReset,
                                                         double _rhoRestart )
    : pargeo::point<dim>(),
      counter( 0 ),
      cReset( _cReset ),
...
template <int dim>
void
pargeo::seedSpreader::internal::spreader<dim>::restart()
{
   counter = 0;
...
template <int dim>
void
pargeo::seedSpreader::internal::spreader<dim>::shift()
{
   counter = 0;
...
template <int dim>
pargeo::seedSpreader::internal::simdenSpreader<dim>::simdenSpreader(
    int _cReset, double _rhoRestart, double _rShift, double _rVincinity )
...
template <int dim>
void
pargeo::seedSpreader::internal::vardenSpreader<dim>::step()
{
...
pargeo::seedSpreader::simdenGenerator( size_t n, double rhoNoise )
{
   ...
   auto sp = internal::simdenSpreader<dim>(
       100, 10.0 / ( n * ( 1.0 - rhoNoise ) ), 50 * dim, 100 );
...
pargeo::seedSpreader::vardenGenerator( size_t n, double rhoNoise )
{
   ...
   auto sp =
       internal::vardenSpreader<dim>( 100, 10.0 / ( n * ( 1.0 - rhoNoise ) ) );
